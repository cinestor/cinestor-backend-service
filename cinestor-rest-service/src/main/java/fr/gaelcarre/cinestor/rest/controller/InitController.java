...
public class InitController {
	...
	// return "Contrairement à une opinion répandue, le Lorem Ipsum n'est pas
	...
	// dans la littérature classique, découvrit la source incontestable du Lorem
	// Ipsum. Il provient en fait des sections 1.10.32 et 1.10.33 du \"De
	// Finibus Bonorum et Malorum\" (Des Suprêmes Biens et des Suprêmes Maux) de
	// Cicéron. Cet ouvrage, très populaire pendant la Renaissance, est un
	// traité sur la théorie de l'éthique. Les premières lignes du Lorem Ipsum,
	// \"Lorem ipsum dolor sit amet...\", proviennent de la section
	// 1.10.32.L'extrait standard de Lorem Ipsum utilisé depuis le XVIè siècle
	// est reproduit ci-dessous pour les curieux. Les sections 1.10.32 et
	// 1.10.33 du \"De Finibus Bonorum et Malorum\" de Cicéron sont aussi
	// reproduites dans leur version originale, accompagnée de la traduction
	...
	// à la vente de feuilles Letraset contenant des passages du Lorem Ipsum,
	// et, plus récemment, par son inclusion dans des applications de mise en
	...
	// ch.setDescription("Un justicier mystérieux errant dans le Far West qui
	// est un as de la gâchette");
	// c.setType(TypeElement.CHARACTER);
	// s.setElements(new HashSet<>());
	// s.getElements().add(c);
	// Element cc = new Element();
	// cc.setName("Marine Le Pen");
	// cc.setSheet("Un justicier mystérieux errant dans le Far West qui est un
	// as de la gâchette");
